...
class NetSuitePortType < ::SOAP::RPC::Driver
  ...
  Methods = [
    [ "login",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"NetSuite::InsufficientPermissionFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"InsufficientPermissionFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::InvalidAccountFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"InvalidAccountFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::InvalidCredentialsFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"InvalidCredentialsFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::InvalidVersionFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"InvalidVersionFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::ExceededRequestLimitFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"ExceededRequestLimitFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::UnexpectedErrorFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"UnexpectedErrorFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}} }
    ],
    [ "ssoLogin",
      "ssoLogin",
    ...
    [ "logout",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"NetSuite::InvalidSessionFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"InvalidSessionFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::ExceededRequestLimitFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"ExceededRequestLimitFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::UnexpectedErrorFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"UnexpectedErrorFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}} }
    ],
    [ "add",
      "add",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"NetSuite::InvalidSessionFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"InvalidSessionFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::InvalidCredentialsFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"InvalidCredentialsFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::ExceededRequestLimitFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"ExceededRequestLimitFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::ExceededUsageLimitFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"ExceededUsageLimitFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::ExceededRecordCountFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"ExceededRecordCountFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::ExceededRequestSizeFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"ExceededRequestSizeFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::UnexpectedErrorFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"UnexpectedErrorFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}} }
    ],
    [ "delete",
      "delete",
    ...
    [ "initialize",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"NetSuite::InvalidSessionFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"InvalidSessionFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::InvalidCredentialsFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"InvalidCredentialsFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::ExceededRecordCountFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"ExceededRecordCountFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::ExceededRequestLimitFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"ExceededRequestLimitFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::ExceededUsageLimitFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"ExceededUsageLimitFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::ExceededRequestSizeFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"ExceededRequestSizeFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::UnexpectedErrorFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"UnexpectedErrorFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}} }
    ],
    [ "initializeList",
      "initializeList",
    ...
    [ "getDataCenterUrls",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"NetSuite::ExceededRequestSizeFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"ExceededRequestSizeFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::UnexpectedErrorFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"UnexpectedErrorFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}} }
    ],
    ...
    [ "getServerTime",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"NetSuite::InvalidSessionFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"InvalidSessionFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::InvalidCredentialsFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"InvalidCredentialsFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::ExceededRequestLimitFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"ExceededRequestLimitFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::ExceededUsageLimitFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"ExceededUsageLimitFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::UnexpectedErrorFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"UnexpectedErrorFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}} }
    ],
    [ "attach",
      "attach",
    ...
    [ "getAsyncResult",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"NetSuite::InvalidSessionFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"InvalidSessionFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::InvalidCredentialsFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"InvalidCredentialsFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::ExceededRequestLimitFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"ExceededRequestLimitFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::ExceededUsageLimitFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"ExceededUsageLimitFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::ExceededRecordCountFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"ExceededRecordCountFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::ExceededRequestSizeFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"ExceededRequestSizeFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::UnexpectedErrorFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"UnexpectedErrorFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::AsyncFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"AsyncFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}} }
    ],
    [ "checkAsyncStatus",
      "checkAsyncStatus",
    ...
    [ "getDeleted",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"NetSuite::InvalidSessionFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"InvalidSessionFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::InvalidCredentialsFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"InvalidCredentialsFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::ExceededUsageLimitFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"ExceededUsageLimitFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::ExceededRecordCountFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"ExceededRecordCountFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::ExceededRequestLimitFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"ExceededRequestLimitFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::ExceededRequestSizeFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"ExceededRequestSizeFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "NetSuite::UnexpectedErrorFault_"=>{:ns=>"urn:platform_2013_2.webservices.netsuite.com", :name=>"UnexpectedErrorFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}} }
    ]
  ]
  ...
  def initialize(endpoint_url = nil)
    ...
    self.mapping_registry = ::NetSuite::DefaultMappingRegistry::EncodedRegistry
    self.literal_mapping_registry = ::NetSuite::DefaultMappingRegistry::LiteralRegistry
    init_methods
  end
